...
ever<-rast("reports/egreen_final.asc")
...
```{r forest_summaries, message= FALSE, warning = FALSE, echo=FALSE, eval = FALSE}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, out.width = "80%", fig.align = 'center', fig.cap = "Deciduous and evergreen forest cover"}
...
```{r forest_change, message = FALSE, warning =FALSE, echo = FALSE, eval = FALSE}
...
```{r pop_change, message = FALSE, warning = FALSE, echo=FALSE}
...
```{r eco_services, echo = FALSE, out.width = "55%", fig.align = 'center', fig.cap= "% change in aboveground live biomas and soil organic carbon"}
