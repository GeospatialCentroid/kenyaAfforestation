...
# Summary Report for `r params$county_name` County for the year `r paste0("20", params$time)`
...
The maps below show historic and 2030 baseline tree cover and the change between the two for `r params$county_name` for the year `r paste0("20", params$time)`
...
How does tree cover extent in `r params$county_name` County change by the year `r paste0("20", params$time)` under scenarios of climate change and natural fire disturbance:
