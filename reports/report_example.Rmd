...
## Historic and 2030 baseline forest cover

The maps below show historic and 2030 baseline forest cover and the change between the two for `r params$county_name` for the year `r paste0("20", params$time)`
...
h <- tm_shape(params$historic, bbox = county_select) +
  ...
  tm_layout(
    legend.outside = TRUE,
    frame = FALSE,
    main.title = "Historic Forest Cover",
    main.title.position = "left",
    main.title.size = 1,
    main.title.fontface = "bold",
    outer.margins = c(0, 0, 0, 0)
...
b <- tm_shape(params$baseline, bbox = county_select) +
  ...
  tm_layout(
    legend.outside = TRUE,
    frame = FALSE,
    main.title = "2030 Baseline Forest Cover",
    main.title.position = "left",
    main.title.size = 1,
    main.title.fontface = "bold",
    outer.margins = c(0, 0, 0, 0)
...
c <- tm_shape(forest_change, bbox = county_select) +
  ...
  tm_layout(
    legend.outside = TRUE,
    frame = FALSE,
    main.title = "Forest Cover Change",
    main.title.position = "left",
    main.title.size = 1,
    main.title.fontface = "bold",
    outer.margins = c(0, 0, 0, 0)
...
## Forest cover change under future climate and disturbance scenarios
...
How might forests in `r params$county_name` County change by the year `r paste0("20", params$time)` under 4 scenarios of climate change and 3 disturbance scenarios (i.e., fire severity):
...
pop_data <- population[grepl(pattern = params$time, x = names(population))]
