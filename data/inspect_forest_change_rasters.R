...
ack<-list ("rgdal", "raster", "sp", "stringr", "rasterVis", "RColorBrewer", "gridExtra")
lapply(pack, "library", character.only = TRUE)
## Read the forest cover rasters and plot them

## Existing cover

existing<-raster("existing_forest.tif")


##Expanded cover in 2030 (baseline)

expanded<-raster("expanded_forest.tif")
...
DoNothing<-readRDS("ssp126_DoNothing.rds")
StopFires<-readRDS("ssp126_StopFires.rds")
